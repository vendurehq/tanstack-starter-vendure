...
export const Route = createFileRoute('/account/orders')({
  ...
  loader: async ({deps: {page}}) => {
    const result = await query(GetCustomerOrdersQuery, {options: {take: ITEMS_PER_PAGE, skip: (page - 1) * ITEMS_PER_PAGE, filter: {state: {notEq: 'AddingItems'}}}}, {useAuthToken: true})
...
function OrdersRoute() { return <Page ordersData={Route.useLoaderData()} currentPage={Route.useSearch().page} /> }
